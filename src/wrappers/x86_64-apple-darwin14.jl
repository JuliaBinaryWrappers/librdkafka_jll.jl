# Autogenerated wrapper script for librdkafka_jll for x86_64-apple-darwin14
export librdkafka
...
const librdkafka_splitpath = ["lib", "librdkafka.1.dylib"]
...
const librdkafka = "@rpath/librdkafka.1.dylib"
