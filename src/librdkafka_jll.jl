...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import librdkafka_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7943bfb0-7437-5acd-a008-22777931c7aa"))
platforms = [Pkg.Artifacts.unpack_platform(e, "librdkafka", artifacts_toml) for e in artifacts["librdkafka"]]
...
if best_platform === nothing
    @debug("Unable to load librdkafka; unsupported platform $(triplet(platform_key_abi()))")
else
